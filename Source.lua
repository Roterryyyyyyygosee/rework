...
local source = game:HttpGet("https://raw.githubusercontent.com/Roterryyyyyyygosee/Rotlua/refs/heads/main/loader.lua")
local threadSource = [[
...
--    runSource(run_on_thread, getactorthreads)
elseif string.find(executor, "isaeva") and (not getgenv().executed) then
